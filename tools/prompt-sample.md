...
## 2. Node-REDでobnizノードを動かしたいプロンプトサンプル
...
- 距離が200以下になったら、LEDを点灯する
- 距離が200より大きくなったら、LEDを消灯する
- obnizとNode-REDを使ってセンサーとLEDを制御する

フローの生成には、以下の点を厳密に守ってください。

1. obniz repeatノード (型: "obniz-repeat")
...
3. obniz functionノード (型: "obniz-function")
...
5. 分かりやすい名前とコメントを各ノードに付ける

6. 生成されたJSONは、マークダウン形式のコードブロックで出力してください。

7. obnizの設定ノード (型: "obniz")は出力に含めないで下さい。
```

> [改善版](https://gist.github.com/n0bisuke/9499d288aff06e00e45e03b7d70066f1)
