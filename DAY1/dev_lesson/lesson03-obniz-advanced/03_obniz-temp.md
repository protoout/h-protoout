...
```JSON
[{"id":"325b5a769a36c509","type":"obniz-repeat","z":"50bd6451c23b920d","obniz":"","name":"","interval":100,"code":"msg.payload = await obnizParts.dht20.getAllDataWait();\n\n\nreturn msg;","x":370,"y":180,"wires":[["7fb0eb02ddbb7791"]]},{"id":"7fb0eb02ddbb7791","type":"debug","z":"50bd6451c23b920d","name":"debug 1","active":true,"tosidebar":true,"console":false,"tostatus":false,"complete":"false","statusVal":"","statusType":"auto","x":620,"y":180,"wires":[]}]
