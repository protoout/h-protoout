...
`chagenノード`の値を変えて`injectノード`から実行させると条件によって違った文言が右側のデバッグコンソールに表示されます。
...
Effibot に聞くことで、おそらくこんなコードが生成されていると思います。
...
エラーが出ても落ち着いて、一旦人に聞く前に生成 AI に聞くという選択肢も持ってみて下さい。

### 2-8. よくない例

「`"ReferenceError: sensorValue is not defined (line 5, col 1)"`とエラーが出た」とだけ Effibot に送るとどうなるでしょうか。

> <img src="https://i.gyazo.com/7ff4891640e7f07ec691d2a569846506.png" width="400px" />

Effibot は状況が分からないので、予想してArduinoと呼ばれる別のプログラミング言語（環境）のコードを生成してきました。
...
当たってそうで当たってない回答ですね。これは Node-RED では基本的に動作しないコードとなります。
