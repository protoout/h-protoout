...
最新話題のGPT-4o（omni）を把握しつつ、機能の一部を触ってみましょう。
...
2. 次に[こちらのリスト](https://docs.google.com/spreadsheets/d/1G1lZX74bEyMyo9YwId6vUD_SVOj3IZyTHnGBUc8hsVs/edit?usp=sharing)からOpenAIのAPIキーをコピーします。
    ...
    APIキーは一旦運営側で発行しているものになります。お金が掛かってしまうので研修外では使わないようにしてください。
...
ボタンを押すと写真が撮影されます。（ここで詰まる人はブラウザの設定問題が怪しいです。）

何か手書きのテキストなどをカメラに読ませてみましょう。

上手くいくとこのようになり、デバッグの箇所に認識された文字列が表示されます。
...
> 手書き文字の`nobisuke`と`n0bisuke`を判別できてるのはかなりすごいです。
> 
...
早く終わった人は色々写真を撮って試してみましょう。 

## 3. 世の中のスピードが加速する

一昨日、GPT-4oが出て世界が変わりました。

そして昨日はGoogle I/Oがあり、そこでも色々な情報が出ていました。

- [Google I/Oで発表されたこと総まとめ](https://www.gizmodo.jp/2024/05/google-io-2024-announcements.html)
- [マルチモーダルなチャットボットからAI検索、Google WorkspaceとGeminiの統合まで。グーグルが「Google I/O 2024」で発表した7つのこと](https://wired.jp/article/everything-google-announced-at-io-2024/)

GoogleもマルチモーダルAI（GPT-4oのように複数の情報を扱えるAI）を発表してきましたね。

## 4. 今回の授業

世の中マルチモーダルAIが話題になってきていますが、とはいえまだまだ戦国時代的にLLMをどう使いこなすかはホットトピックであることには変わりません。
話題のLLMを中心にAIをどう扱うか？をやっていこうと思います。
