...
3. 生成AIでフローを0から作って改善してみるハンズオン
    - [3. 0から生成AIで作ってみる](./lesson01-generative-ai/03_1_zero1.md)
4. 生成AIが作ったフローの改修やデバッグ（時間があれば実施）
    - [4-1. 生成AIが作ったフローを改修](./lesson01-generative-ai/04_1_one2.md)
    - [4-2. 生成AIが作ったフローを改修](./lesson01-generative-ai/04_2_ten99.md)
