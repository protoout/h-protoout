 # A-2. OpenAIのノードをつかってみよう wisperを使って、音声でLEDを操作する


## 1.音声でLEDを操作するものを作ります！
完成イメージは以下。
...
このハンズオンではPCのマイクを使います。そのために、SSL化されている（通信が暗号化されている）WebApps側のサーバーのNode-RED環境で行う必要があります。

みなさんのNode-REDのURLバーを確認してください。

- NG: セキュリティ保護なしと出る → Node−REDの環境を変える必要があります
...
<a href="https://gyazo.com/2340a26edf8451c86594e43281c620dc"><img src="https://i.gyazo.com/2340a26edf8451c86594e43281c620dc.png" alt="Image from Gyazo" width="600"/></a>
